...
describe CrateRuby::ResultSet do
  let(:crate_result) do
  ...
  describe '#each' do
    it 'loops over the result rows' do
  ...
  describe '#values_at' do
    it 'only returns the columns specified' do
      a = []
    ...
    it 'does not raise an error on invalid column names' do
      expect do
  ...
  describe '#values' do
    it 'returns all rows as an array of arrays' do
